...
const HCIBindings = require("../lib/hci-socket/bindings");
const fs = require("fs");
const STATUS_MAPPER = require('../lib/hci-socket/hci-status');
...
noble.on("discover", function (peripheral) {
  if (peripheral.address == "61:09:01:de:00:42") {
...
const connectToDevice = function (peripheral) {
  peripheral.on('disconnect', function (reason) {
    console.log(`Perephiral ${peripheral.address} disconnected with reason: ${STATUS_MAPPER[reason]}`);
